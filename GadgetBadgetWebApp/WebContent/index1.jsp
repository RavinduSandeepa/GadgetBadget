...
<body>
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					...
					<div class="login-box">
						<select id="basic" class="selectpicker show-tick form-control"
							...
							<option value="checkout.html">Register Here</option>
							<option>Researcher</option>
							<option>Investor</option>
							<option>Seller</option>
							<option value="my-account.html">Sign In</option>
						</select>
						<script>
							function la(src)
							{
				...
				<div class="collapse navbar-collapse" id="navbar-menu">
					<ul class="nav navbar-nav ml-auto" data-in="fadeInDown"
						...
						<li class="dropdown"><a href="#"
							...
							<li class="nav-item"><a class="nav-link" href="">Researches</a></li>
	...
	<div id="slides-shop" class="cover-slides">
		<ul class="slides-container">
			<li class="text-center"><img src="images/banner-01.jpg" alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20">
								<strong>Welcome To <br> GadgetBadget
								</strong>
							</h1>
							<p class="m-b-40">
			...
			<li class="text-center"><img src="images/banner-04.jpg" alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20">
			...
			<li class="text-center"><img src="images/banner-05.jpg" alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20">
